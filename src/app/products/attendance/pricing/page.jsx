...
const faqs = [
  {
    q: "1. Is attendance tracking unlimited for all plans?",
    a: "Yes. You can record unlimited check-ins and check-outs across all plans.",
  },
  {
    q: "2. Can employees use mobile and web to mark attendance?",
    a: "Yes. Both mobile and desktop access are included in all paid plans.",
  },
  {
    q: "3. Does the pricing change based on the number of employees?",
    a: "Plans are billed per user, so you only pay for the employees you add.",
  },
  {
    q: "4. Are leave management and shift scheduling included?",
    a: "They are included in mid and higher-tier plans; basic attendance is part of all plans.",
  },
  {
    q: "5. Can I export attendance data for payroll?",
    a: "Yes. You can export to Excel/PDF, and advanced plans offer automated insights for payroll.",
  },
];
