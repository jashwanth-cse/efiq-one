            ...
            {isLoading && (
                ...
                >
                    ...
                    <div className="flex flex-col items-center gap-6">
                        ...
                        {/* The SVG Mark */}
                        <div className="h-24 w-auto flex justify-center items-center drop-shadow-2xl">
                            <svg viewBox="10 0 80 95" className="h-full w-auto overflow-visible" aria-hidden="true">
                                {/* Green Top Shape sliding in from slightly above + fading in */}
                                <motion.path
                                ...
                                {/* Blue Bottom "U" Shape sliding up + fading in */}
                                <motion.path
                                    initial={{ y: 25, opacity: 0, scale: 0.9 }}
                                    animate={{ y: 0, opacity: 1, scale: 1 }}
                                    transition={{
                        ...
                        {/* Typography */}
                        <div className="flex flex-col justify-center items-center h-16 overflow-hidden">
                            <motion.span
                                initial={{ opacity: 0, y: 15 }}
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ duration: 0.5, ease: "easeOut", delay: 0.7 }}
                                className="font-orbitron font-bold text-[18px] tracking-[0.2em] text-white leading-none mb-1 ml-1"
                            >
                                EFIQ
                            </motion.span>
                            <motion.span
                                ...
                                className="font-orbitron font-black text-[38px] text-zinc-300 leading-none tracking-tight"
                            >
                                ONE
                            </motion.span>
                        </div>
                    ...
                    <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-48 h-1 bg-white/10 rounded-full overflow-hidden">
                        <motion.div
                            ...
                            className="h-full w-full bg-gradient-to-r from-transparent via-brand-green to-transparent"
                        />
                    </div>
